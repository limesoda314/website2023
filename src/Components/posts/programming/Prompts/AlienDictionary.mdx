...
description: Solution for Verifying an Alien Dictionary
tags: 
    - leetcode
    - coding
    - programming
...
[Leetcode link](https://leetcode.com/problems/verifying-an-alien-dictionary/) • [Question List](Coding-Questions)
