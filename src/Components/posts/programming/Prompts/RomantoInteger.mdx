...
description: Solution for Roman to Integer 
tags: 
    - leetcode
    - coding
    - programming
...
[Leetcode](https://leetcode.com/problems/roman-to-integer/) • [Question List](Coding-Questions)
...
unordered_map<char, string> exception_map {
    {'I', "VX"},
    {'X', "LC"},
    {'C', "DM"}
};
