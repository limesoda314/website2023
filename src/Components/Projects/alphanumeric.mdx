...
For the UCR course CS180 Introduction to Software Engineering, I partnered up with [Ivan Neto](https://ivanneto.dev/) to create a website that took user input (writing on a react canvas component or a file upload) and displayed the prediction of what letter or number it was.
